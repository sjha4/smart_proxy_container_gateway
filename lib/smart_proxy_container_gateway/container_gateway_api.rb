    ...
    class Api < ::Sinatra::Base
      ...
      get '/v2/token' do
        ...
        unless token_response_body['token'] == AuthorizationHeader::UNAUTHENTICATED_TOKEN
          ...
          puts JSON.parse(repo_response.body)
      ...
      put '/update_hosts/?' do
        ...
        database.connection.transaction(isolation: :serializable, retry_on: [Sequel::SerializationFailure]) do
          ...
          hosts_table.delete
          hosts_table.import(%i[name uuid], hosts.map { |host| [host['name'], host['uuid']] })
        end
      ...
      put '/host_repository_mapping/?' do
        ...
        host_repo_mappings = params['host_repository_mappings'] || []
